...
public final class PaymentApiConstants {
    ...
    public static final String COLLECT_BULK = PAYMENT_BASE + "/collect/bulk";
    public static final String STUDENT_COLLECT_BULK = PAYMENT_BASE + "/students/{studentId}/collect/bulk";
